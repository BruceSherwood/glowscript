; (function () {
    ...
    function initObject(obj, constructor, args) {
        ...
        if (constructor != points && constructor != text) {
        ...
        if (window.__GSlang == 'vpython' && !(constructor == vp_sphere || constructor == vp_ring)) obj.__sizing = true
    ...
    property.declare( Primitive.prototype, {
        ...
        up:    new attributeVectorUp(null, 0,1,0),
        opacity: {
        ...
        visible: {
            get: function() {
            	...
            	if (this instanceof text) return this.__comp.__id != null
        ...
        clone: function(args) { // cloning a primitive; cloning a compound is different
    		...
    		if (args.up === undefined) args.up = this.__up // save current up
        	if (this instanceof text) { // the text object is a wrapper around an extrusion, which is a compound
        		var comp = this.__comp.clone()
        		var bill = this.__billboard
        		if (args.billboard !== undefined) {
        			bill = args.billboard
        			delete args.billboard
        		}        		
	        	var newargs = {__pos:this.__pos, __offset:this.__offset, canvas:this.canvas, __comp:comp,
        				__color:this.__color, __opacity:this.__opacity, 
	        			__size:this.__size, __axis:this.__axis, __text:this.__text,
	        			__height:this.__height, __depth:this.__depth,
	        			__font:this.__font, __align:this.__align, __billboard:bill,
        ...
        rotate: function (args) {
        	...
        	if (obj instanceof text) obj = obj.__comp
	...
	function text(args) { // 3D text object
		...
		if (args.__comp === undefined) { // not cloning
			...
			this.__color = this.__comp.__color // don't overwrite start and end face colors during constructor phase
		...
		initObject(this, text, args)
		this.__update() // update position of compound
	}
    ...
    property.declare( text.prototype, {
        __update: function() {
        	...
        	var pos = this.__pos.add(this.__offset)
            this.__comp.pos = pos // will trigger update to this.__comp compound object
        ...
        length: {
        	get: function() { return this.__comp.__size.x },
        	set: function(value) {
        		var m = value/this.__comp.__size.x
    	...
    	depth: { // 3D text object; depth > 0 means extrude in +z direction
    		...
    		set: function(value) {
    			...
    			this.__comp.__pos.z = value/2
    			this.__offset.z = value/2
				this.__depth = value
        		this.__comp.__change()
    		}
    	},
    	axis: { // must rotate up (used in __update) as well as set axis
    		get: function() { return this.__comp.__axis },
    		set: function(value) {
    			var axis = this.__comp.__axis
    			var zaxis = cross(axis,value)
    			var angle = diff_angle(axis,value)
    			if (angle > 0) this.__comp.rotate({angle:angle, axis:zaxis, origin:this.__pos})
    		}
    	},
    	size: {
    		get: function() { return this.__comp.__size },
    		set: function(value) {
    			var m = value.y/this.__comp.__size.y
    			this.length = value.x
    			this.height *= m
    			if (this.depth >= 0) this.depth = value.z
    			else this.depth = -value.z
    		}
    	},
    	up: {
    		get: function() { return this.__comp.__up },
    		set: function(value) {
    			this.__comp.up = value
    		}
    	},
    	color: {
    		get: function() { return this.__color },
    		set: function(value) { 
                if (!this.__constructing) { // don't overwrite start and end face colors during constructor phase
                	this.__comp.color = this.__color = value
                }
                this.__constructing = false
    		}
    	},
    	...
    	opacity: {
    		get: function() { return this.__opacity },
    		set: function(value) { this.__comp.opacity = this.__opacity = value }
    	},
    	shininess: {
    		get: function() { return this.__shininess },
    		set: function(value) { this.__shininess = this.__comp.shininess = value }
    	},
    	emissive: {
    		get: function() { return this.__emissive },
    		set: function(value) { this.__comp.emissive = this.__emissive = value }
    	},
    	show_start_face: {
            ...
            if (o instanceof triangle || o instanceof quad) {
            	...
            	for (var k=0; k<N; k++) {
            		if (k == 3) {
	            		...
	            		update_extent( self, mesh.merge(o.v0, o.v0, -3) )
	            		update_extent( self, mesh.merge(o.v2, o.v2, -1) )
	            		update_extent( self, mesh.merge(o.v3, o.v3, 0) )	            			
            		} else {
	            		update_extent( self, mesh.merge(q[k], q[k], 0) )
            		}
            	...
            	var comp = o.__comp
            	update_extent( self, mesh.merge(comp.getTransformedMesh(), comp, 0) )
            	...
            	update_extent( self, mesh.merge(o.getTransformedMesh(), o, 0) )
            }
            o.visible = false
    ...
    var exports = {
        ...
        ring: ring, 
        vp_ring: vp_ring,
        compound: compound, vp_compound: vp_compound,
        vertex: vertex,
        triangle: triangle,
        quad: quad,
        draw: draw,
