...
7) Insert these statements at the start of runtime.js (this is a kludge; don't know how to invoke the new compiler):
	...
	var RS_len;
8) Recently runtime.js already starts with "var RS_len;", so you can delete the duplicate line if present.
        ...
        if (options.lang == "rapydscript" || options.lang == 'vpython') {
        	...
        	if (program.slice(0,7) == 'ERROR: ') {
	        	...
	        	if (options.lang == 'rapydscript') {
	                ...
	                //program = program.replace(/\.pop\s*\(/g, '.pypop(') // Make pop equivalent to pypop (RapydScript python-like pop); makes set.pop() fail
